...
export default class Map {
  ...
  // Tambahkan method alternatif di class Map (maps.js)
  static async getPlaceNameByCoordinateOSM(latitude, longitude) {
    try {
      ...
      console.error('Error getting OSM location:', error);
      return `${latitude}, ${longitude}`;
    }
  }
